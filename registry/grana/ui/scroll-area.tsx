...
/* A scrolling region with a quiet overlay scrollbar: a stone thumb on a transparent track,
 * nothing painted until the content overflows. The viewport takes the global focus ring. */
function ScrollArea({
  className,
  children,
  ...props
